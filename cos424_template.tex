...
\begin{figure}[ht!]
	% Requires \usepackage{graphicx}
	\centering
	\includegraphics*[scale=0.85, viewport= -5mm 0mm 500mm 100mm, angle=0]{./figure/sta_lta}
...
\begin{figure}[ht!]
	% Requires \usepackage{graphicx}
	\centering
	\includegraphics*[scale=0.35, viewport= 40mm 0mm 500mm 150mm, angle=0]{./figure/empirical_measurements.png}
...
\begin{figure}[ht!]
	% Requires \usepackage{graphicx}
	\centering
	\includegraphics*[scale=0.25, viewport= 35mm 40mm 500mm 500mm, angle=0]{./figure/prediction_vs_true.png}
...
\begin{figure}[ht!]
	% Requires \usepackage{graphicx}
	\centering
	\includegraphics*[scale=0.5, viewport= 10mm 0mm 500mm 120mm, angle=0]{./figure/Feature_importance_lasso_RF.pdf}
